...
<footer className="footer p-10 bg-base-200 text-base-content">
  <aside>
    <h2 className='text-3xl'>Ziifood</h2>
  </aside> 
  <nav>
  ...
  <nav>
    ...
    <a className="link link-hover">ziifood16@gmail.com</a>
    <a className="link link-hover">+62 856 123 123</a>
  </nav> 
  <form onSubmit={handleSubscribe}>
    <h6 className="footer-title">Newsletter</h6> 
    <fieldset className="form-control w-80">
      <label className="label">
        <span className="label-text">Enter email for subscribe</span>
      </label> 
      <div className="join">
        <input 
            type="email" 
